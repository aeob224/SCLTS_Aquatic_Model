...
## This is done to demonstrate the predictive ability of our metric
...
residuals_depth_plot <- ggplot(df, aes(x = depth, y = residuals)) +
...
ggsave("Figures/residuals_vs_depth.jpg", residuals_depth_plot)
